...
#endif
{
	...
	tree.createAndAddParameter("osc2FM", "Osc2FM", "Osc2FM", oscs2FMParam, 0.00f, nullptr, nullptr);
	/*--------------------------------------------------------*/
	...
	NormalisableRange<float> filter1CutoffParam(20.0f, 15000.0f, 1.0f); //Hz
	tree.createAndAddParameter("filter1Cutoff", "Filter1Cutoff", "Filter1Cutoff", filter1CutoffParam, 400.0f, nullptr, nullptr);
	NormalisableRange<float> filter1ResonanceParam(0.0f, 10.0f, 0.1f); 
	tree.createAndAddParameter("filter1Resonance", "Filter1Resonance", "Filter1Resonance", filter1ResonanceParam, 0.0f, nullptr, nullptr);
	/*--------------------------------------------------------*/


	/*====================== Envelopes =======================*/
	NormalisableRange<float> envsAttackParam(50.0f, 5000.0f, 1.0f); //miliseconds
	NormalisableRange<float> envsDecayParam(50.0f, 5000.0f, 1.0f);
	NormalisableRange<float> envsSustainParam(0.0f, 1.0f, 0.01f);
	NormalisableRange<float> envsReleaseParam(50.0f, 5000.0f, 1.0f);

	tree.createAndAddParameter("envelope1Attack", "Envelope1Attack", "Envelope1Attack", envsAttackParam, 100.0f, nullptr, nullptr); //default value 100.0f
	tree.createAndAddParameter("envelope1Decay", "Envelope1Decay", "Envelope1Decay", envsDecayParam, 100.0f, nullptr, nullptr);
	tree.createAndAddParameter("envelope1Sustain", "Envelope1Sustain", "Envelope1Sustain", envsSustainParam, 1.0f, nullptr, nullptr);
	tree.createAndAddParameter("envelope1Release", "Envelope1Release", "Envelope1Release", envsReleaseParam, 100.0f, nullptr, nullptr);

	tree.createAndAddParameter("envelope2Attack", "Envelope2Attack", "Envelope2Attack", envsAttackParam, 100.0f, nullptr, nullptr); 
	tree.createAndAddParameter("envelope2Decay", "Envelope2Decay", "Envelope2Decay", envsDecayParam, 100.0f, nullptr, nullptr);
	tree.createAndAddParameter("envelope2Sustain", "Envelope2Sustain", "Envelope2Sustain", envsSustainParam, 1.0f, nullptr, nullptr);
	tree.createAndAddParameter("envelope2Release", "Envelope2Release", "Envelope2Release", envsReleaseParam, 100.0f, nullptr, nullptr);
	/*--------------------------------------------------------*/
...
void RonSynthAudioProcessor::processBlock (AudioBuffer<float>& buffer, MidiBuffer& midiMessages)
{
	for (int i = 0; i < mySynth.getNumVoices(); i++)
	{
		if (myVoice = dynamic_cast<SynthVoice*>(mySynth.getVoice(i)))
		{
			...
			/*Envelopes*/
			myVoice->getEnvelope1(tree.getRawParameterValue("envelope1Attack"),
			...
			myVoice->getEnvelope2(tree.getRawParameterValue("envelope2Attack"),
