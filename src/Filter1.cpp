...
Filter1::Filter1(RonSynthAudioProcessor& p) : processor{p}
{
	...
	filter1CutoffSL.setRange(20.0f, 20000.0f); //Hz
	...
	filter1CutoffSL.setSkewFactorFromMidPoint(1000.0f);//funcion para generar una forma logaritmica de incrementar el slider con el param como punto medio
	...
	//filter1ResonanceSL.setTextValueSuffix(" Hz");
