...
Envelope1::Envelope1(RonSynthAudioProcessor& p) : processor{p}
{
	...
	envelope1AttackSL.setRange(0.1f, 5000.0f);
	...
	envelope1DecaySL.setRange(0.1f, 5000.0f);
	...
	envelope1SustainSL.setRange(0.1f, 5000.0f);
	...
	//envelope1SustainSL.setTextValueSuffix(" ms");
	...
	envelope1ReleaseSL.setRange(0.1f, 5000.0f);
